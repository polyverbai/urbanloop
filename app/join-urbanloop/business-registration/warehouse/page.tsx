...
const router = useRouter();
 ...
 // Warehouse Profile
const [facilitySize, setFacilitySize] =
  useState("");
...
if (
  ...
  alert(
    "Please complete all Warehouse Profile fields"
  );
  return;
}
...
monthly_recyclables:
  ...
  Warehouse & Logistics Registration
</h1>

<p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-slate-600">
  Register your warehouse,
  distribution centre or logistics
  facility with UrbanLoop.
</p>
...
<p className="mb-6 text-slate-600">
  Select recyclable materials generated by your warehouse and logistics operations.
</p>
