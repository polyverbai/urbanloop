...
if (
  ...
  alert(
    "Please complete all Hotel Profile fields"
  );
  return;
}
          ...
          <div className="mx-auto max-w-5xl px-6">
            ...
            <div className="mb-12 text-center">
              ...
              <h1 className="mt-4 text-3xl font-bold text-slate-900 md:text-4xl">
                Hotel & Hospitality Registration
              </h1>

              <p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-slate-600">
                Register your hotel, resort, serviced apartment or hospitality business with UrbanLoop.
              </p>
...
<p className="mb-6 text-slate-600">
  Select recyclable materials generated by your hotel and hospitality operations.
</p>
