...
const [monthlyWasteVolume,
  setMonthlyWasteVolume] =
  useState("");
...
if (
  ...
  alert(
    "Please complete all Service Business Profile fields"
  );
  return;
}
...
<p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-slate-600">
  Register your office, consultancy,
