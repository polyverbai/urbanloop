...
if (
  ...
  alert(
    "Please complete all Restaurant Profile fields"
  );
  return;
}
...
organic_waste:
  organicWaste,
    ...
    router.push(
  "/registration-success?type=Restaurant%20Registration&return=/join-urbanloop/business-registration"
);
  }
          ...
          <div className="mx-auto max-w-5xl px-6">
            ...
            <div className="mb-12 text-center">
              ...
              <p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-slate-600">
                ...
                café, bakery or food service
                business with UrbanLoop.
              </p>
...
<div className="grid gap-6 md:grid-cols-2">
  ...
  <div>
    ...
    <select
      value={organicWaste}
      onChange={(e) =>
        setOrganicWaste(e.target.value)
      }
      className="w-full rounded-xl border-2 border-slate-300 px-4 py-3"
    >
...
<p className="mb-6 text-slate-600">
  Select recyclable materials generated by your restaurant operations.
</p>
