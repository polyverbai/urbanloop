...
<p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-slate-600">
                Register your school with UrbanLoop and recover recyclable materials, books, furniture, IT assets and e-waste while supporting sustainability goals.
              </p>
...
<div className="grid gap-6 md:grid-cols-2">
  ...
  <div>
    ...
    <select className="w-full rounded-xl border-2 border-slate-300 px-4 py-3">
      <option>Select Student Range</option>
      <option>1 - 100</option>
  ...
  <div>
    ...
    <input
      type="text"
      placeholder="e.g. 25000 sq.ft or 5 Acres"
      className="w-full rounded-xl border-2 border-slate-300 px-4 py-3"
    />
  </div>
...
<div className="mt-12 border-t border-[#E6EFE0] pt-10">
  ...
  <div className="text-center">
    ...
    >
      Register School With UrbanLoop
    </button>
