...
export default function coachingcenterRegistrationPage() {
  return (
    <>
      <Header />
...
<p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-slate-600">
                Register your coaching center with UrbanLoop and recover recyclable materials, books, furniture, IT assets and e-waste while supporting sustainability goals.
              </p>
...
<div className="grid gap-6 md:grid-cols-2">
  ...
  <div>
    <label className="mb-2 block text-sm font-medium text-slate-700">
      Affiliation / Accreditation Number
    </label>
...
<div className="grid gap-6 md:grid-cols-2">
  ...
  <div>
    ...
    <select className="w-full rounded-xl border-2 border-slate-300 px-4 py-3">
      ...
      <option>Entrance Exam Coaching</option>
      <option>Academic Tuition Center</option>
      <option>Language Coaching</option>
      <option>Professional Certification</option>
      <option>Online Coaching</option>
      <option>Skill Development Coaching</option>
    </select>
  </div>
...
<div className="grid gap-6 md:grid-cols-2">
  ...
  <div>
    ...
    <select className="w-full rounded-xl border-2 border-slate-300 px-4 py-3">
      ...
      <option>Educational & Coaching Network</option>
...
<div className="mt-12 border-t border-[#E6EFE0] pt-10">
  ...
  <div className="text-center">
    ...
    >
      Register Coaching Center With UrbanLoop
    </button>
