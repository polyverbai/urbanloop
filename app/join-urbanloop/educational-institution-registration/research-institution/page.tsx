...
export default function researchinstutionRegistrationPage() {
  return (
    <>
      <Header />
...
<p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-slate-600">
                Register your research institution with UrbanLoop and recover recyclable materials, books, furniture, IT assets and e-waste while supporting sustainability goals.
              </p>
...
<div className="grid gap-6 md:grid-cols-2">
  ...
  <div>
    ...
    <select className="w-full rounded-xl border-2 border-slate-300 px-4 py-3">
      <option>Select Research Domain</option>
  ...
  <div>
    ...
    <select className="w-full rounded-xl border-2 border-slate-300 px-4 py-3">
      ...
      <option>Technology Incubator</option>
...
<div className="grid gap-6 md:grid-cols-2">
  ...
  <div>
    ...
    <select className="w-full rounded-xl border-2 border-slate-300 px-4 py-3">
      ...
      <option>Research & Innovation Network</option>
...
<div className="mt-12 border-t border-[#E6EFE0] pt-10">
  ...
  <div className="text-center">
    ...
    >
      Register Research Institution With UrbanLoop
    </button>
