...
<p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-slate-600">
                Register your university with UrbanLoop and recover recyclable materials, books, furniture, IT assets and e-waste while supporting sustainability goals.
              </p>
...
<div className="mt-12 border-t border-[#E6EFE0] pt-10">
  ...
  <div className="text-center">
    ...
    >
      Register University With UrbanLoop
    </button>
