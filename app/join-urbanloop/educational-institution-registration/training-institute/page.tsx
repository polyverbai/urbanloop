...
export default function traininginstituteRegistrationPage() {
  return (
    <>
      <Header />
...
<p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-slate-600">
                Register your training institute with UrbanLoop and recover recyclable materials, books, furniture, IT assets and e-waste while supporting sustainability goals.
              </p>
...
<div className="grid gap-6 md:grid-cols-2">
  ...
  <div>
    ...
    <select className="w-full rounded-xl border-2 border-slate-300 px-4 py-3">
      ...
      <option>Training & Skill Development Network</option>
...
<div className="mt-12 border-t border-[#E6EFE0] pt-10">
  ...
  <div className="text-center">
    ...
    >
      Register Training Institute With UrbanLoop
    </button>
