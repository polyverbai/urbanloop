  ...
  <div className="mx-auto max-w-7xl px-6">
    ...
    <div className="mx-auto mb-16 max-w-3xl text-center">
      ...
      <p className="mt-6 text-lg leading-relaxed text-slate-600">
        ...
        for different types of communities and organizations.
      </p>
    ...
    <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
      ...
      {/* Apartments */}
      <div className="group rounded-[28px] border border-[#DDE8D0] bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:border-[#72B543] hover:bg-[#F8FBF4] hover:shadow-[0_20px_40px_rgba(114,181,67,0.18)]">
        <Building2 size={28} className="mb-4 text-[#72B543]" />
        ...
        <Link
          href="/join-urbanloop/apartments"
          className="mt-5 inline-flex items-center gap-2 rounded-lg bg-[#72B543] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#5FA032]"
        >
          Register Now
          <ArrowRight size={16} />
      ...
      <div className="group rounded-[28px] border border-[#DDE8D0] bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:border-[#72B543] hover:bg-[#F8FBF4] hover:shadow-[0_20px_40px_rgba(114,181,67,0.18)]">
        ...
        <Link
          href="/join-urbanloop/corporates"
          className="mt-5 inline-flex items-center gap-2 rounded-lg bg-[#72B543] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#5FA032]"
        >
          Register Now
          <ArrowRight size={16} />
      ...
      <div className="group rounded-[28px] border border-[#DDE8D0] bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:border-[#72B543] hover:bg-[#F8FBF4] hover:shadow-[0_20px_40px_rgba(114,181,67,0.18)]">
        <GraduationCap size={28} className="mb-4 text-[#72B543]" />
      ...
      <div className="group rounded-[28px] border border-[#DDE8D0] bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-2 hover:border-[#72B543] hover:bg-[#F8FBF4] hover:shadow-[0_20px_40px_rgba(114,181,67,0.18)]">
        <Landmark size={28} className="mb-4 text-[#72B543]" />
        ...
        <Link
          href="/join-urbanloop/institutions"
          className="mt-5 inline-flex items-center gap-2 rounded-lg bg-[#72B543] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#5FA032]"
        >
          Register Now
          <ArrowRight size={16} />
