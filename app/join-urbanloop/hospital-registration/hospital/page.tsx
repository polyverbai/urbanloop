          ...
          <div className="mx-auto max-w-5xl px-6">
            ...
            <div className="mb-12 text-center">
              ...
              <p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-slate-600">
                Register your hospital with UrbanLoop and implement responsible
...
<div className="grid gap-6 md:grid-cols-2 mb-5"></div>
              ...
              <p className="mb-6 text-slate-600">
                Select recyclable and recoverable materials generated by your hospital.
              </p>
...
<div className="grid gap-6 md:grid-cols-2 mb-5"></div>
              ...
              <div className="mt-12 border-t border-[#E6EFE0] pt-10">
                ...
                <div className="text-center">
                  ...
                  >
                    Register Hospital With UrbanLoop
                  </button>
