...
export default function DiagnosticRegistrationPage() {
  return (
    <>
      <Header />
          ...
          <div className="mx-auto max-w-5xl px-6">
            ...
            <div className="mb-12 text-center">
              ...
              <p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-slate-600">
                Register your diagnostic center with UrbanLoop and implement responsible
...
<div className="grid gap-6 md:grid-cols-2 mb-5"></div>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div>
                  <label className="mb-2 block text-sm font-medium text-slate-700">
                    Building / Diagnostic Center Name *
                  </label>
...
<div className="grid gap-6 md:grid-cols-2">
  ...
  <div>
    ...
    <select className="w-full rounded-xl border-2 border-slate-300 px-4 py-3">
      ...
      <option>MRI Center</option>
      <option>CT Scan Center</option>
      <option>Multi-Diagnostic Center</option>
    </select>
  </div>

  <div>
    <label className="mb-2 block text-sm font-medium text-slate-700">
      Number of Diagnostic Units *
    </label>
...
<div className="grid gap-6 md:grid-cols-2 mb-5"></div>
              ...
              <p className="mb-6 text-slate-600">
                Select recyclable and recoverable materials generated by your diagnostic center.
              </p>
...
<div className="grid gap-6 md:grid-cols-2 mb-5"></div>
  ...
  "One-Time Clearance",
  "Furniture Recovery",
  "Diagnostic Furniture Recovery",
  "Diagnostic Equipment Recovery",
...
<div>
                  ...
                  <div>
                    <label className="mb-2 block text-sm font-medium text-slate-700">
                      Authorized Biomedical Waste Disposal Partner
                    </label>

                    <input
                      type="text"
                      placeholder="Authorized Biomedical Waste Disposal Partner"
                      className="w-full rounded-xl border-2 border-slate-300 px-4 py-3"
                    />
                  </div>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div>
                  ...
                  <select className="w-full rounded-xl border-2 border-slate-300 px-4 py-3">
                    ...
                    <option>Diagnostic Association</option>
...
<div className="grid gap-6 md:grid-cols-2 mb-5"></div>
              ...
              <div className="mt-12 border-t border-[#E6EFE0] pt-10">
                ...
                <div className="text-center">
                  ...
                  >
                    Register Diagnostic Center with UrbanLoop
                  </button>
