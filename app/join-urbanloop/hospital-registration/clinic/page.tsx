          ...
          <div className="mx-auto max-w-5xl px-6">
            ...
            <div className="mb-12 text-center">
              ...
              <p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-slate-600">
                Register your clinic with UrbanLoop and implement responsible
...
<div className="grid gap-6 md:grid-cols-2 mb-5"></div>
              ...
              <p className="mb-6 text-slate-600">
                Select recyclable and recoverable materials generated by your clinic.
              </p>
                ...
                <div>
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    {[
                      ...
                      "One-Time Clearance",
                      "Furniture Recovery",
                      "Clinic Furniture Recovery",
                      "Clinic Equipment Recovery",
                      "IT Asset Recovery",
                      "E-Waste Collection",
...
<div>
                  ...
                  <div>
                    <label className="mb-2 block text-sm font-medium text-slate-700">
                      Authorized Biomedical Waste Vendor
                    </label>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div>
                  ...
                  <select className="w-full rounded-xl border-2 border-slate-300 px-4 py-3">
                    ...
                    <option>Healthcare Conference</option>
...
<div className="grid gap-6 md:grid-cols-2 mb-5"></div>
              ...
              <div className="mt-12 border-t border-[#E6EFE0] pt-10">
                ...
                <div className="text-center">
                  ...
                  >
                    Register Clinic with UrbanLoop
                  </button>
