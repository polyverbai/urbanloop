...
export default function financialRegistrationPage() {
  return (
    <>
      <Header />
...
<p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-slate-600">
                Register your financial services organization with UrbanLoop and implement efficient recycling, sustainability and responsible workplace waste management programs.
              </p>
...
<div className="mt-12 border-t border-[#E6EFE0] pt-10">
  ...
  <div className="text-center">
    ...
    >
      Register Financial Services Organization
    </button>
