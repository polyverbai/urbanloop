...
export default function bpokpoRegistrationPage() {
  return (
    <>
      <Header />
...
<h1 className="mt-4 text-3xl font-bold text-slate-900 md:text-4xl">
                BPO / KPO Registration
              </h1>

<p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-slate-600">
                Register your BPO or KPO organization with UrbanLoop and implement efficient recycling, workplace sustainability and waste recovery programs.
              </p>
