...
export default function governmentofficesRegistrationPage() {
  return (
    <>
      <Header />
...
<h1 className="mt-4 text-3xl font-bold text-slate-900 md:text-4xl">
                Government Office Registration
              </h1>

<p className="mx-auto mt-4 max-w-3xl text-base leading-relaxed text-slate-600">
                Register your government office with UrbanLoop and support responsible recycling, sustainability initiatives and efficient waste management practices.
              </p>
